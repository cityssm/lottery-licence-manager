...
const getLicenceActivityByDateRange = (startDate, endDate, _reqBody) => {
    const db = sqlite(databasePaths_1.licencesDB, {
        readonly: true
    });
    const activity = {
