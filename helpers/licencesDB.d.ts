...
export declare const getRawRowsColumns: (sql: string, parameters: Array<string | number>, userFunctions: Map<string, (...parameters: unknown[]) => unknown>) => RawRowsColumnsReturn;
