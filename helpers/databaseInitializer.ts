...
export function initLicencesDB(): boolean {
  ...
  if (!row) {
    ...
    licencesDB
      .prepare(
        `create table if not exists OrganizationRepresentatives (
    ...
    licencesDB
      .prepare(
        `create table if not exists OrganizationRemarks (
          organizationID integer not null,
    ...
    licencesDB
      .prepare(
        `create table if not exists OrganizationReminders (
          organizationID integer not null,
    ...
    licencesDB
      .prepare(
        'create table BankingMonths (bankingMonth integer primary key not null)'
      )
      .run()
    ...
    licencesDB
      .prepare(
        `create table if not exists OrganizationBankRecords (
          organizationID integer not null,
    ...
    licencesDB
      .prepare(
        `create table if not exists LotteryLicences (
    ...
    licencesDB
      .prepare(
        `create index if not exists LotteryLicences_ExternalLicenceNumberInteger_Index on LotteryLicences
    ...
    licencesDB
      .prepare(
        `create table if not exists LotteryLicenceTransactions (
    ...
    licencesDB
      .prepare(
        `create table if not exists LotteryLicenceAmendments (
          licenceID integer not null,
    ...
    licencesDB
      .prepare(
        `create table if not exists LotteryLicenceTicketTypes (
          licenceID integer not null,
    ...
    licencesDB
      .prepare(
        `create table if not exists LotteryLicenceFields (
          licenceID integer not null,
    ...
    licencesDB
      .prepare(
        `create table if not exists LotteryEventCosts (
          licenceID integer not null,
          eventDate integer not null,
    ...
    licencesDB
      .prepare(
        `create table if not exists LotteryEventFields (
          licenceID integer not null,
          eventDate integer not null,
          fieldKey varchar(20) not null,
          fieldValue text,
