...
router.post(
  '/:organizationID/doAddOrganizationRepresentative',
  permissionHandlers.createPostHandler,
  handler_doAddRepresentative
)

router.post(
  '/:organizationID/doEditOrganizationRepresentative',
  permissionHandlers.createPostHandler,
  handler_doUpdateRepresentative
)

router.post(
  '/:organizationID/doDeleteOrganizationRepresentative',
  permissionHandlers.createPostHandler,
  handler_doDeleteRepresentative
)

router.post(
  '/:organizationID/doSetDefaultRepresentative',
  permissionHandlers.createPostHandler,
