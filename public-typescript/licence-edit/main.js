...
(() => {
    ...
    llm.licenceEdit.setUnsavedChangesFunction = (changeEvent) => {
        ...
        if (changeEvent) {
            const currentTargetType = changeEvent.currentTarget instanceof HTMLInputElement
    ...
    }
    {
        ...
        const organizationLookupFunction_setOrganization = (clickEvent) => {
            ...
            document.querySelector('#licence--organizationID').value = organizationElement.getAttribute('data-organization-id');
            document.querySelector('#licence--organizationName').value = organizationElement.getAttribute('data-organization-name');
        ...
        const organizationLookupFunction_openModal = () => {
            cityssm.openHtmlModal('licence-organizationLookup', {
                onshow() {
                    organizationLookupSearchStringElement = document.querySelector('#organizationLookup--searchStr');
    ...
    }
    {
            ...
            if (eventDate) {
                if (eventDate instanceof Date) {
                    ...
                    try {
                        ...
                        const sourceElementID = eventDate.currentTarget
                            .dataset.source;
        ...
        document
            ...
            .addEventListener('click', () => {
            const eventCount = Number.parseInt(document.querySelector('#eventCalc--eventCount')
                .value, 10);
            ...
            cityssm.openHtmlModal('licence-transactionAdd', {
                onshow(modalElement) {
                    llm.getDefaultConfigProperty('externalReceiptNumber_fieldLabel', (fieldLabel) => {
                        ;
                        modalElement.querySelector("label[for='transactionAdd--externalReceiptNumber']").textContent = fieldLabel;
                    });
                    ...
                    const transactionTotal = Number.parseFloat(transactionTotalElement
        ...
        if (voidTransactionButtonElement) {
            voidTransactionButtonElement.addEventListener('click', () => {
                ...
                cityssm.confirmModal('Void Transaction?', '<strong>Are you sure you want to void this transaction?</strong><br />' +
                    ...
                    '.', 'Void Transaction', 'warning', voidFunction);
            });
        }
    }
    if (!isCreate) {
