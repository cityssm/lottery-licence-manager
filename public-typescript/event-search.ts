...
import type { DoSearchEventsResponse } from '../handlers/events-post/doSearch.js'
...
;(() => {
  ...
  function doEventSearchFunction(): void {
    ...
    cityssm.postJSON(
      `${urlPrefix}/events/doSearch`,
      formElement,
      (rawResponseJSON) => {
        const eventResults =
          rawResponseJSON as unknown as DoSearchEventsResponse
        ...
        for (const eventObject of eventList) {
          const licenceType: string =
            exports.config_licenceTypes[eventObject.licenceTypeKey] ??
            eventObject.licenceTypeKey
          ...
          trElement.innerHTML = `<td>
              ...
              <td>
                ...
                <small>
                  ${eventObject.startTimeString}${
                    eventObject.startTimeString === eventObject.endTimeString
                      ? ''
  ...
  function resetOffsetAndDoEventSearchFunction(): void {
