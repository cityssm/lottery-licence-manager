...
"checked")});c.getElementsByTagName("form")[0].addEventListener("submit",e)},onshown:function(a,b){d=b;document.getElementById("editRemark--remark").focus()}})},deleteRemark:function(a,b,c,d){c?cityssm.confirmModal("Delete Remark?","Are you sure you want to delete this remark?","Yes, Delete","danger",function(){e(a,b,d)}):e(a,b,d)}}}();
