...
(function () {
    ...
    }
    {
        ...
        var termsConditionsLookupFn_setTermsConditions_1 = function (clickEvent) {
            clickEvent.preventDefault();
            var termsConditionsIndex = parseInt(clickEvent.currentTarget.getAttribute("data-terms-conditions-index"), 10);
    ...
    }
    {
        ...
        document.getElementsByClassName("is-calculate-events-button")[0].addEventListener("click", function () {
            var eventCount = parseInt(document.getElementById("eventCalc--eventCount").value, 10);
            var dayInterval = parseInt(document.getElementById("eventCalc--dayInterval").value, 10);
            var dateSplit = endDateEle_1.value.split("-");
            var endDate = new Date(parseInt(dateSplit[0], 10), parseInt(dateSplit[1], 10) - 1, parseInt(dateSplit[2], 10));
            dateSplit = startDateEle_1.value.split("-");
            var eventDate = new Date(parseInt(dateSplit[0], 10), parseInt(dateSplit[1], 10) - 1, parseInt(dateSplit[2], 10));
    ...
    if (ticketTypesPanelEle) {
        ...
        var amendUnitCount_openModal_1 = function (buttonEvent) {
            ...
            var amendUnitCount_closeAndUpdate = function (formEvent) {
                formEvent.preventDefault();
                var unitCount = parseInt(document.getElementById("amendUnit_unitCount").value, 10);
        ...
        var addTicketType_openModal = function () {
            ...
            var addTicketType_refreshUnitCountChange = function () {
                var unitCount = parseInt(addTicketType_unitCountEle.value, 10);
