(function(){function n(b){var c=b.currentTarget;b=cityssm.escapeHTML(c.getAttribute("data-location-display-name"));cityssm.confirmModal("Delete Location?","Are you sure you want delete "+b+"?","Yes, Delete","danger",function(){var b=c.getAttribute("data-location-id");cityssm.postJSON("/locations/doDelete",{locationID:b},function(b){b.success?(cityssm.alertModal(b.message,"","OK","success"),c.closest("tr").remove()):cityssm.alertModal(b.message,"","OK","danger")})})}function f(){h.innerHTML='<p class="has-text-centered has-text-grey-lighter"><i class="fas fa-3x fa-circle-notch fa-spin" aria-hidden="true"></i><br /><em>Loading locations...</em></p>';
