(function(){function f(){d.classList.remove("has-status-view");d.classList.add("has-status-loading");llm.postJSON("/events/doGetFinancialSummary",t,function(f){for(var g=k.children,e=0;e<g.length;e+=1)g[e].classList.add("is-hidden");for(var l=e=g=0,m=0,n=0,p=0,q=0,r=0,h=0;h<f.length;h+=1){var a=f[h],b=k.querySelector("tr[data-licence-type-key='"+a.licenceTypeKey+"']");b.querySelector("[data-field='licenceCount']").innerText=a.licenceCount;g+=a.licenceCount;b.querySelector("[data-field='costs_receiptsSum']").innerText=
