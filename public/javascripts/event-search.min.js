...
b.eventDate+'">'+window.llm.escapeHTML(b.externalLicenceNumber)+"<br /><small>Licence #"+b.licenceID+"</small></a></div>")+('<div class="column">'+window.llm.escapeHTML(b.organizationName)+"</div>")+('<div class="column">'+g+"<br /><small>"+window.llm.escapeHTML(b.licenceDetails)+"</small></div>")+('<div class="column">'+window.llm.escapeHTML(b.location)+"<br /><small>"+b.startTimeString+" to "+b.endTimeString+"</small></div>")+(b.canUpdate?'<div class="column is-narrow is-hidden-print"><a class="button is-small" href="/events/'+
