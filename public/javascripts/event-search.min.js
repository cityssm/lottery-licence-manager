...
a.eventDate+'">'+llm.escapeHTML(a.externalLicenceNumber)+"<br /><small>Licence #"+a.licenceID+"</small></a></div>")+('<div class="column">'+llm.escapeHTML(a.organizationName)+"</div>")+('<div class="column">'+g+"<br /><small>"+llm.escapeHTML(a.licenceDetails)+"</small></div>")+('<div class="column">'+llm.escapeHTML(a.locationDisplayName)+"<br /><small>"+a.startTimeString+(a.startTimeString===a.endTimeString?"":" to "+a.endTimeString)+"</small></div>")+'<div class="column is-1-desktop is-hidden-print has-text-right">'+
(a.canUpdate?'<a class="button is-small" href="/events/'+a.licenceID+"/"+a.eventDate+'/edit"><span class="icon"><i class="fas fa-pencil-alt" aria-hidden="true"></i></span><span>Edit</span></a>':"")+"</div></div></li>")}e.insertAdjacentElement("beforeend",f)}})}var l=llm.arrayToObject(config_licenceTypes,"licenceTypeKey"),b=document.getElementById("filter--month"),c=document.getElementById("filter--year"),e=document.getElementById("container--events");document.getElementById("filter--previous").addEventListener("click",
