...
g);f.insertAdjacentHTML("beforeend","<td>"+(l?'<div class="field has-addons justify-flex-end"><p class="control"><a class="button is-small" data-tooltip="Edit Organization" href="/organizations/'+e.OrganizationID+'/edit"><span class="icon"><i class="fas fa-pencil-alt" aria-hidden="true"></i></span><span>Edit</span></a></p><p class="control"><a class="button is-small" data-tooltip="Create a New Licence" href="/licences/new/'+e.OrganizationID+'"><span class="icon"><i class="fas fa-certificate" aria-hidden="true"></i></span><span>New</span></a></p></div>':
"")+"</td>");c.insertAdjacentElement("beforeend",f)}}})}var c=document.getElementById("form--filters"),b=document.getElementById("container--searchResults"),l="true"===b.getAttribute("data-can-update");c.addEventListener("submit",function(a){a.preventDefault()});for(var k=c.getElementsByTagName("input"),a=0;a<k.length;a+=1)k[a].addEventListener("change",h);h()})();
