...
a.organizationID+'"><span class="icon"><i class="fas fa-certificate" aria-hidden="true"></i></span><span>New</span></a>':"")+"</td>");e.insertAdjacentElement("beforeend",d)}}})}var e=document.getElementById("form--filters"),g=document.getElementById("container--searchResults"),h="true"===document.getElementsByTagName("main")[0].getAttribute("data-can-create");e.addEventListener("submit",function(c){c.preventDefault()});for(var l=e.querySelectorAll(".input, .select"),c=0;c<l.length;c+=1)l[c].addEventListener("change",
k);k()})();
