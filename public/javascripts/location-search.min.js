...
r=document.getElementById("filter--limit"),l=document.getElementById("filter--offset"),g=document.getElementById("container--searchResults"),m="true"===document.getElementsByTagName("main")[0].getAttribute("data-can-create"),f=[],n;n=function(a){a.preventDefault();a=parseInt(a.currentTarget.getAttribute("data-location-index"));var d=f[a];llm.confirmModal("Delete Location","Are you sure you want to delete "+cityssm.escapeHTML(d.locationDisplayName)+"?","Yes, Delete","warning",function(){cityssm.postJSON("/locations/doDelete",
