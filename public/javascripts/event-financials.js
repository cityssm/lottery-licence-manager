  ...
  function getFinancialSummary() {
    ...
    llm.postJSON("/events/doGetFinancialSummary", formEle, function(summary) {
      ...
      for (let summaryIndex = 0; summaryIndex < summary.length; summaryIndex += 1) {
        ...
        trEle.querySelector("[data-field='costs_receiptsSum']").innerText = "$ " + licenceTypeSummaryObj.costs_receiptsSum.toFixed(2);
        costs_receiptsSum += licenceTypeSummaryObj.costs_receiptsSum;

        trEle.querySelector("[data-field='costs_adminSum']").innerText = "$ " + licenceTypeSummaryObj.costs_adminSum.toFixed(2);
        costs_adminSum += licenceTypeSummaryObj.costs_adminSum;

        trEle.querySelector("[data-field='costs_prizesAwardedSum']").innerText = "$ " + licenceTypeSummaryObj.costs_prizesAwardedSum.toFixed(2);
        costs_prizesAwardedSum += licenceTypeSummaryObj.costs_prizesAwardedSum;

        trEle.querySelector("[data-field='costs_charitableDonationsSum']").innerText = "$ " + licenceTypeSummaryObj.costs_charitableDonationsSum.toFixed(2);
        costs_charitableDonationsSum += licenceTypeSummaryObj.costs_charitableDonationsSum;

        trEle.querySelector("[data-field='costs_netProceedsSum']").innerText = "$ " + licenceTypeSummaryObj.costs_netProceedsSum.toFixed(2);
        costs_netProceedsSum += licenceTypeSummaryObj.costs_netProceedsSum;

        trEle.querySelector("[data-field='costs_amountDonatedSum']").innerText = "$ " + licenceTypeSummaryObj.costs_amountDonatedSum.toFixed(2);
        costs_amountDonatedSum += licenceTypeSummaryObj.costs_amountDonatedSum;

        trEle.querySelector("[data-field='licenceFeeSum']").innerText = "$ " + licenceTypeSummaryObj.licenceFeeSum.toFixed(2);
      ...
      tfootEle.querySelector("[data-field='costs_receiptsSum']").innerText = "$ " + costs_receiptsSum.toFixed(2);
      tfootEle.querySelector("[data-field='costs_adminSum']").innerText = "$ " + costs_adminSum.toFixed(2);
      tfootEle.querySelector("[data-field='costs_prizesAwardedSum']").innerText = "$ " + costs_prizesAwardedSum.toFixed(2);
      tfootEle.querySelector("[data-field='costs_charitableDonationsSum']").innerText = "$ " + costs_charitableDonationsSum.toFixed(2);
      tfootEle.querySelector("[data-field='costs_netProceedsSum']").innerText = "$ " + costs_netProceedsSum.toFixed(2);
      tfootEle.querySelector("[data-field='costs_amountDonatedSum']").innerText = "$ " + costs_amountDonatedSum.toFixed(2);
