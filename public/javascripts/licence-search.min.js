...
'">'+cityssm.escapeHTML(a.externalLicenceNumber)+"<br /><small>Licence #"+a.licenceID+"</small></a></td><td>"+(k||a.licenceTypeKey)+"<br /><small>"+cityssm.escapeHTML(a.licenceDetails)+"</small></td>"+('<td><a data-tooltip="View Organization" href="/organizations/'+a.organizationID+'">'+cityssm.escapeHTML(a.organizationName)+"</a></td>")+('<td><a data-tooltip="View Location" href="/locations/'+a.locationID+'">'+cityssm.escapeHTML(a.locationDisplayName)+"</a>"+(a.locationDisplayName===a.locationAddress1?
