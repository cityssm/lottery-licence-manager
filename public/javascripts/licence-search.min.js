...
"</small></a></td><td>"+window.llm.escapeHTML(b.OrganizationName)+"</td><td>"+(g||b.LicenceTypeKey)+"<br /><small>"+window.llm.escapeHTML(b.LicenceDetails)+"</small></td>"+('<td><span class="has-tooltip-right" data-tooltip="Start Date"><i class="fas fa-fw fa-play" aria-hidden="true"></i> '+b.StartDateString+'</span><br /><span class="has-tooltip-right" data-tooltip="End Date"><i class="fas fa-fw fa-stop" aria-hidden="true"></i> '+b.EndDateString+"</span></td>")+'<td class="has-text-right">'+(l?'<a class="button is-small" data-tooltip="Edit Licence" href="/licences/'+
b.LicenceID+'/edit"><span class="icon"><i class="fas fa-pencil-alt" aria-hidden="true"></i></span><span>Edit</span></a> ':"")+(b.LicenceFeeIsPaid?'<a class="button is-small" data-tooltip="Print Licence" href="/licences/'+b.LicenceID+'/print" target="_blank"><i class="fas fa-print" aria-hidden="true"></i><span class="sr-only">Print</span></a>':'<span class="tag is-warning">Unpaid</span>')+"</div></td>";d.insertAdjacentElement("beforeend",f)}}})}for(var h={},c=document.getElementById("form--filters"),
e=document.getElementById("container--searchResults"),k=e.getAttribute("data-external-licence-number-label"),l="true"===e.getAttribute("data-can-update"),d=document.getElementById("filter--licenceTypeKey").getElementsByTagName("option"),a=1;a<d.length;a+=1){var f=d[a];h[f.value]=f.innerText}c.addEventListener("submit",function(a){a.preventDefault()});d=c.querySelectorAll(".input, .select select");for(a=0;a<d.length;a+=1)d[a].addEventListener("change",g);g()})();
