...
"</small></a></td><td>"+window.llm.escapeHTML(b.organizationName)+"</td><td>"+(g||b.licenceTypeKey)+"<br /><small>"+window.llm.escapeHTML(b.licenceDetails)+"</small></td>"+('<td class="is-nowrap"><span class="has-cursor-default has-tooltip-right" data-tooltip="Start Date"><i class="fas fa-fw fa-play" aria-hidden="true"></i> '+b.startDateString+'</span><br /><span class="has-cursor-default has-tooltip-right" data-tooltip="End Date"><i class="fas fa-fw fa-stop" aria-hidden="true"></i> '+b.endDateString+
"</span></td>")+'<td class="has-text-right is-nowrap">'+(b.canUpdate?'<a class="button is-small" data-tooltip="Edit Licence" href="/licences/'+b.licenceID+'/edit"><span class="icon"><i class="fas fa-pencil-alt" aria-hidden="true"></i></span><span>Edit</span></a> ':"")+(b.licenceFeeIsPaid?'<a class="button is-small" data-tooltip="Print Licence" href="/licences/'+b.licenceID+'/print" target="_blank"><i class="fas fa-print" aria-hidden="true"></i><span class="sr-only">Print</span></a>':'<span class="tag is-warning">Unpaid</span>')+
"</div></td>";d.insertAdjacentElement("beforeend",f)}}})}for(var h={},c=document.getElementById("form--filters"),e=document.getElementById("container--searchResults"),k=e.getAttribute("data-external-licence-number-label"),d=document.getElementById("filter--licenceTypeKey").getElementsByTagName("option"),a=1;a<d.length;a+=1){var f=d[a];h[f.value]=f.innerText}c.addEventListener("submit",function(a){a.preventDefault()});d=c.querySelectorAll(".input, .select select");for(a=0;a<d.length;a+=1)d[a].addEventListener("change",
g);g()})();
