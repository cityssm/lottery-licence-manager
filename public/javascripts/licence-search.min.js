...
for(var h={},c=document.getElementById("form--filters"),e=document.getElementById("container--searchResults"),k=e.getAttribute("data-external-licence-number-label"),l="true"===e.getAttribute("data-can-update"),d=document.getElementById("filter--licenceTypeKey").getElementsByTagName("option"),a=1;a<d.length;a+=1){var f=d[a];h[f.value]=f.innerText}c.addEventListener("submit",function(a){a.preventDefault()});d=c.querySelectorAll(".input, .select select");for(a=0;a<d.length;a+=1)d[a].addEventListener("change",
g);g()})();
