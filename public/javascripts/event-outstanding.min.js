...
b.insertAdjacentHTML("beforeend",'<td class="has-text-centered">'+(null===a.costs_netProceeds||0===a.costs_netProceeds?'<span class="icon" data-tooltip="Net Proceeds Amount Outstanding"><i class="fas fa-times has-text-danger" aria-hidden="true"></i></span><span class="sr-only">Net Proceeds Amount Outstanding</span>':'<span class="icon" data-tooltip="Net Proceeds Amount Recorded"><i class="fas fa-check has-text-success" aria-hidden="true"></i></span><span class="sr-only">Net Proceeds Amount Recorded</span>')+
"</td>");d.insertAdjacentElement("beforeend",b)}})}var g=document.getElementById("form--outstandingEvents"),d=document.getElementById("tbody--outstandingEvents");c();document.getElementById("filter--licenceTypeKey").addEventListener("change",c)})();
