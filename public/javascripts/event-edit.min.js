...
k.addEventListener("submit",function(c){c.preventDefault();e.innerHTML='Saving... <i class="fas fa-circle-notch fa-spin" aria-hidden="true"></i>';cityssm.postJSON("/events/doSave",k,function(a){a.success&&(cityssm.disableNavBlocker(),p.removeAttribute("disabled"));e.innerHTML="";llm.alertModal(a.message,"","OK",a.success?"success":"danger")})});document.getElementById("is-delete-event-button").addEventListener("click",function(c){c.preventDefault();llm.confirmModal("Delete Event?","Are you sure you want to delete this event?",
