...
q();var r=function(a){window.fetch("/organizations/"+h+"/doSetDefaultRepresentative",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({isDefaultRepresentativeIndex:a.currentTarget.value})}).then(function(b){return b.json()})},d=f.getElementsByTagName("input"),c;for(c=0;c<d.length;c+=1)d[c].addEventListener("change",r);var t=function(a){a.preventDefault();var b=a.currentTarget.closest("tr");a=b.getAttribute("data-representative-name");window.llm.confirmModal("Delete a Representative?",
'<p>Are you sure you want to delete the representative "'+a+'"?</p>',"Yes, Delete","warning",function(){window.fetch("/organizations/"+h+"/doDeleteOrganizationRepresentative",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({representativeIndex:b.getAttribute("data-representative-index")})}).then(function(b){return b.json()}).then(function(a){a.success&&(b.remove(),q())})})},d=f.getElementsByClassName("is-delete-representative-button");for(c=0;c<
d.length;c+=1)d[c].addEventListener("click",t);var k=document.getElementsByClassName("is-edit-representative-modal")[0],d=k.getElementsByTagName("form")[0],e,u=function(a){e=a.currentTarget.closest("tr");a=e.getAttribute("data-representative-index");document.getElementById("editOrganizationRepresentative--representativeIndex").value=a;document.getElementById("editOrganizationRepresentative--representativeName").value=e.getAttribute("data-representative-name");document.getElementById("editOrganizationRepresentative--representativeTitle").value=
