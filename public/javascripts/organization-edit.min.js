...
0<a.length&&a[0].remove();v(b.organizationRepresentative);window.llm.hideModal(l)}})})}c=m.getElementsByClassName("input");for(d=0;d<c.length;d+=1)c[d].addEventListener("change",x);window.llm.initializeTabs(document.getElementById("tabs--licences"))})();
