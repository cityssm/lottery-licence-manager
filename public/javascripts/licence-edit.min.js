...
function(a){a.success&&window.location.reload(!0)})})}):document.getElementById("is-issue-licence-button").addEventListener("click",function(){var a=function(){cityssm.postJSON("/licences/doIssueLicence",{licenceID:l},function(a){a.success&&window.location.reload(!0)})};C?cityssm.alertModal("Unsaved Changes","Please save all unsaved changes before issuing this licence.","OK","warning"):cityssm.confirmModal("Issue Licence?","Are you sure you want to issue this lottery licence?","Yes, Issue","success",
a)}))})();
